...
This program is made like a ghost client and it's written in C# (Injector), C/C++ (The DLL), Java (The Mod). Only the C++ part of this program in made by AI. The rest is coded by me...
